        ...
        {done ? (
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <button onClick={() => setDone(false)} style={{ padding: "14px 32px", backgroundColor: C.cyan, color: "#000", fontWeight: 700, fontSize: 14, border: "none", borderRadius: 2, cursor: "pointer" }}>
                또 다른 문장 남기기
              </button>
              <a href="/feed" style={{ padding: "14px 32px", border: `1px solid ${C.border}`, color: C.muted, textAlign: "center", fontSize: 13, borderRadius: 2, textDecoration: "none" }}>
                피드 보기 →
              </a>
            </div>
          </div>
          ...
          <div style={{ width: "100%", maxWidth: 480 }}>
            <p style={{ fontSize: 10, letterSpacing: "0.35em", color: C.cyan, marginBottom: 16, textAlign: "center" }}>TODAY&apos;S RESONANCE</p>
            <h2 style={{ fontSize: 22, color: C.white, fontWeight: 300, textAlign: "center", lineHeight: 1.5, marginBottom: 32 }}>
            ...
            <button
              ...
              style={{ width: "100%", padding: "16px", backgroundColor: sentence.trim().length >= 5 ? C.cyan : C.border, color: sentence.trim().length >= 5 ? "#000" : C.muted, fontWeight: 700, fontSize: 15, border: "none", borderRadius: 2, cursor: sentence.trim().length >= 5 ? "pointer" : "default" }}
            >
              {loading ? "기록 중…" : "문장 남기기"}
            </button>
          </div>
